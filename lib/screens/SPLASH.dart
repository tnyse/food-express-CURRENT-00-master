...
// import 'package:rive/rive.dart'; todo
...
import 'Login_SignupView/SIGNUP.dart';
...
class SPLASHSTATE extends State<SPLASH> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 8), go_to_home);
  }
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: UpgradeAlert(
          ...
          // new FlareActor("assets/anim/ftesplash.flr",
          //     alignment: Alignment.center,
          //     fit: BoxFit.cover,
          //     animation: "ntro")

        // todo install new intro animation
        // body: const Center(
