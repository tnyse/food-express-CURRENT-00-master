            ...
            FutureBuilder(
                ...
                builder: (context, snapshots) {
                  if (snapshots.hasData) {
                    return Text(
                        '${snapshots.data == null ? 0 : snapshots.data.length} TRUCKS ONLINE',
                        style: GoogleFonts.poppins(
                          fontSize: 11,
                          fontWeight: FontWeight.w500,
                          fontStyle: FontStyle.italic,
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${snapshot.data == null ? '' : snapshot.data[0].detail.toString()}',
                                  style: GoogleFonts.poppins(
                                      fontSize: 11,
  ...
  void initState() {
    ...
    if (Platform.isIOS) {
      ...
      BitmapDescriptor.fromAssetImage(
              ...
              'assets/images/IOStruckmarker.png')
          .then((v) {
        custom_marker = v;
      });
...
// set path to mapstyle
  ...
  Widget MapDetails(snapshots, locationValues, context) {
    var webservices = Provider.of<WebServices>(context, listen: false);
    var locationValues = Provider.of<LocationService>(context, listen: false);
    // var screenMeasurement = MediaQuery.of(context).size.width;
    //
    // double screenSize = .25;
    // getsize() {
    //   if (screenMeasurement > 600) {
    //     screenSize = 0.25;
    //   } else {
    //     screenSize = 0.65;
    //   }
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        for (index_value in snapshots.data) {
          marker.add(Marker(
              infoWindow: InfoWindow(title: '${index_value.distance} Miles'),
            ...
            Align(
              ...
              child: Container(
                ...
                child: PageView.builder(
                    ...
                    controller: PageController(viewportFraction: .65),
                    itemBuilder: (context, index) {
                      if (snapshots.connectionState == ConnectionState.done) {
                        return FutureBuilder(
                            future: webservices
